  ...
  <table class="table mt-4">
    <thead>
      ...
      @foreach ($student as $i=>$student)
        ...
        <tr><td>PSM Evaluation 1</td><td><a href='editScoreForm/1/{{$student->student_id}}'>Update></td></tr>
        <tr><td>PSM Evaluation 2</td><td><a href='editScoreForm/2/{{$student->student_id}}'>Update></td></tr>
      @endforeach
    </thead>
  </table>
  @endsection
